...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-dark">گروه‌ها</li>
    </ul>
@endsection
    ...
    <div class="card shadow-sm">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                @can('groups-create')
                    <a href="{{ route('admin.groups.create') }}" class="btn btn-sm btn-primary">+ گروه جدید</a>
                @endcan
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="permissions_list" class="table table-striped gy-7 gs-7">
                    ...
                    <tr>
                        ...
                        <th class="text-center">دوره مسابقه</th>
                    ...
                    @forelse ($groups as $key => $group)
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $group->competition->title }}</td>
...
{{--                                    @endif--}}
                            ...
                            <td class="text-center">
                                <div class="btn btn-group-sm">
                                    @can('groups-update')
                                        <a href="{{ route('admin.groups.edit', ['group' => $group->id]) }}" class="btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="ویرایش">
