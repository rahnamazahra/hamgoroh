...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('admin.groups.index', ['competition' => $competition->id]) }}" class="text-muted text-hover-primary">گروه بندی مسابقه</a>
        </li>
        <li class="breadcrumb-item">
            <span class="bullet bg-gray-300 w-5px h-2px"></span>
        </li>
        ...
        <form method="POST" action="{{ route('admin.groups.selfStore', ['competition' => $competition->id]) }}" enctype="multipart/form-data">
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-end">
                    <a href="{{ route('admin.groups.index', ['competition' => $competition->id]) }}" id="update_permission_form_cancel" class="btn btn-light me-3">لغو</a>
