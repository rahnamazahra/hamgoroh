...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-dark">اطلاعات تکمیلی</li>
    </ul>
@endsection

@section('content')
    <div class="card shadow-sm col-xl-12">
        <form method="POST" action="{{ route('admin.challenges.info.store', ['competition' => $competition->id, 'challenge' => $challenge->id])}}" enctype="multipart/form-data">
            @csrf
            <div class="card-header">
                <div class="card-title">اطلاعات تکمیلی</div>
            </div>
            <div class="card-body">
                <div class="row g-9">
                    <div class="col-md-12 fv-row">
                        <label for="description" class="form-label">توضیحات</label>
                        <textarea class="form-control" rows="3" id="textarea" name="description">{{ old('description') }}</textarea>
                    </div>
                </div>
