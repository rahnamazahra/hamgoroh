<!--begin::Modal-->
<div class="modal fade" id="fieldCreateModal" wire:ignore.self tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">ثبت رشته جدید</h5>
                <!--begin::Close-->
            ...
            <form id="fieldCraeteForm">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" wire:click.prevent="create()">ذخیره</button>
                </div>
            </form>
        </div>
    </div>
