...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-dark">ویرایش تکنیک</li>
    </ul>
@endsection
    ...
    <div class="card shadow-sm col-xl-12">
        <form method="POST" action="{{ route('admin.techniques.update', ['technique' => $technique->id, 'challenge' => $challenge->id])}}" enctype="multipart/form-data">
            ...
            <div class="card-header">
                <div class="card-title">ویرایش تکنیک</div>
            </div>
            <div class="card-body">
                <div class="row g-9">
                     <div class="col-md-12 fv-row">
                        <label for="title" class="required form-label">عنوان</label>
                        <input type="text" class="form-control form-control-solid" name="title" value="{{ old('title', $technique->title) }}"/>
                    </div>
                    <div class="col-md-12 fv-row">
                        <label for="description" class="form-label">توضیحات</label>
                        <textarea class="form-control" rows="3" name="description">{{ old('description', $technique->description) }}</textarea>
                    </div>
                </div>
                <div class="col-md-4 fv-row my-5">
                    ...
                    <input type="file" name="file" class="form-control form-control-solid" value="{{ old('file', $technique->file) }}" accept="">
