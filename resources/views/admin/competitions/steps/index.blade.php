                ...
                <div id="kt_docs_repeater_nested">
                    <!--begin::Form group-->
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="javascript:;" data-repeater-create class="btn btn-primary btn-flex h-40px border-0 fw-bolder px-4 px-lg-6">
                                افزودن گروه
                                        ...
                                        <div id="inner-repeater" class="inner-repeater">
                                            <div data-repeater-list="kt_docs_repeater_nested_inner" class="mb-5">
                                                <div class="d-flex flex-row-reverse" style="position: absolute;padding:0px;top:-80px;left:0px;">
                                                    <div class="p-2">
                                                        <button class="btn btn-sm btn-light-success" data-repeater-create type="button">
                                                            افزودن
                                                            <i class="la la-plus"></i>
                                                        </button>
                                                    </div>
                                                    <div class="p-2">
                                                        <a href="javascript:;" data-repeater-delete class="btn btn-sm btn-light-danger">
                                                            <i class="la la-trash-o fs-3"></i>حذف گروه
                                                        </a>
                                                    </div>
                                                </div>
                                                <div data-repeater-item>
