        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                @can('competitions-create')
                    <a href="{{ route('admin.competitions.create') }}" class="btn btn-sm btn-primary">دوره جدید +</a>
                @endcan
            </div>
        </div>
        <div class="card-body">
...
{{--                            <td class="text-center">{{ $competition->banner }}</td>--}}
                            <td class="text-center">{{ $competition->user->first_name . ' ' . $competition->user->last_name}}</td>

                            <td class="text-center">
                                <div class="btn btn-group-sm">
                                    <a href="{{ route('admin.competitions.show', ['competition' => $competition->id]) }}" class="btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="اطلاعات تکمیلی">
                                    ...
                                    @can('competitions-update')
                                        <a href="{{ route('admin.competitions.edit', ['competition' => $competition->id]) }}" class="btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="ویرایش">
                                                <span class="svg-icon svg-icon-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <button name="btn_delete_item" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm me-1" data-id="{{ $competition->id }}" data-url="{{ route('admin.competitions.delete', ['competition' => $competition->id]) }}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="حذف">
                                        <span class="svg-icon svg-icon-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
