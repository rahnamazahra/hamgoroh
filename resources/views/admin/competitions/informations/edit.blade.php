            ...
            <div class="card-body">
                <div class="row g-9">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <select class="form-select form-select-solid" id="creator" name="creator" data-control="select2" data-allow-clear="true" data-placeholder="لطفا انتخاب کنید">
                            <option></option>
...
{{--                                    <option value="{{ $minute }}" @if ((old('start_time2') === null && $competition->registration_finish_time->format('i') == $minute) || old('start_time2') == $minute) selected @endif>{{ sprintf("%02d", $minute) }}</option>--}}
{{--                                @endforeach--}}
{{--                            </select>--}}
{{--                            <select class="form-select form-select-solid me-2" id="start_time1" name="start_time1">--}}
{{--                                @for ($hour = 0; $hour <= 23; $hour++)--}}
