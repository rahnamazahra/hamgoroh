...
<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">تعریف اطلاعات کلی مسابقه</h1>
...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-dark">تعریف اطلاعات کلی مسابقه</li>
</ul>
@endsection
